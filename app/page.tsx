...
export default function HomePage() {
  ...
  return (
    <div className="w-full bg-ink text-warm-white font-sans selection:bg-warm-white selection:text-ink">
      ...
      <section
        id="hero"
        className="w-full min-h-[calc(90vh-80px)] flex flex-col justify-center items-center relative overflow-hidden px-6 sm:px-8 py-20 sm:py-28 md:py-36"
      >
        ...
        <div className="w-full max-w-5xl mx-auto relative z-10 flex flex-col items-center text-center">
          ...
          <div
            className="h-[3px] w-24 rounded-full overflow-hidden mb-8"
            style={{
              background:
          ...
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/10 mb-7 backdrop-blur-sm">
          ...
          {/* Headline (H1) */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight leading-[1.08] text-warm-white max-w-4xl mb-7">
            {hero.headline}
          </h1>

          {/* Subline */}
          <p className="text-base sm:text-lg md:text-xl text-platinum/85 font-light leading-relaxed max-w-2xl mb-10">
            {hero.subline}
          </p>
